...
function ColorGradientControlSelect(props) {
  var colorGradientSettings = (0, _data.useSelect)(function (select) {
    var settings = select('core/block-editor').getSettings();
    return (0, _lodash.pick)(settings, colorsAndGradientKeys);
  });
  return (0, _element.createElement)(ColorGradientControlInner, _objectSpread({}, colorGradientSettings, {}, props));
}

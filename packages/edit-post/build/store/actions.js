...
var _marked = /*#__PURE__*/_regenerator.default.mark(openGeneralSidebar),
    _marked2 = /*#__PURE__*/_regenerator.default.mark(closeGeneralSidebar);
  ...
  return _regenerator.default.wrap(function openGeneralSidebar$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _dataControls.dispatch)('core/interface', 'enableComplementaryArea', 'core/edit-post', name);
  ...
  return _regenerator.default.wrap(function closeGeneralSidebar$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return (0, _dataControls.dispatch)('core/interface', 'disableComplementaryArea', 'core/edit-post');

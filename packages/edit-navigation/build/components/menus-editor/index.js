...
var _createMenuArea = _interopRequireDefault(require("./create-menu-area"));

var _navigationEditor = _interopRequireDefault(require("../navigation-editor"));
...
function MenusEditor(_ref) {
  ...
  return (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_components.Card, {
    ...
    onChange: function onChange(selectedMenuId) {
      return setMenuId(Number(selectedMenuId));
    },
    value: menuId
  ...
  }, (0, _i18n.__)('Create a new menu'))))), isCreateMenuPanelVisible && (0, _element.createElement)(_createMenuArea.default, {
    menus: stateMenus,
  ...
  }), hasMenus && (0, _element.createElement)(_navigationEditor.default, {
    menuId: menuId,

...
var _menuItem = _interopRequireDefault(require("./menu-item.native"));
...
var _default = (0, _compose.compose)((0, _data.withSelect)(function (select, _ref2) {
  ...
  return {
    ...
    items: shouldAddClipboardBlock ? [_objectSpread({}, (0, _lodash.pick)(getBlockType(clipboardBlock.name), ['name', 'icon']), {
      id: 'clipboard',

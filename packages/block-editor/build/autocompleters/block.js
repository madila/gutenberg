...
var _utils = require("../components/inserter/utils");
  ...
  return {
    ...
    useItems: function useItems(filterValue) {
      ...
      var filteredItems = (0, _element.useMemo)(function () {
        return (0, _searchItems.searchBlockItems)(items, categories, collections, filterValue).filter(function (item) {
      ...
      var options = (0, _element.useMemo)(function () {
        return (0, _utils.includeVariationsInInserterItems)(filteredItems).map(function (blockItem) {

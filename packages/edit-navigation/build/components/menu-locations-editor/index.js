...
function MenuLocationsEditor() {
  ...
  if (menuLocations.length === 0) {
    return (0, _element.createElement)(_components.Card, null, (0, _element.createElement)(_components.CardHeader, null, (0, _i18n.__)('Menu locations')), (0, _element.createElement)(_components.CardBody, null, (0, _element.createElement)("p", null, (0, _i18n.__)('There are no available menu locations'))));
  }

  if (menus.length === 0) {
    return (0, _element.createElement)(_components.Card, null, (0, _element.createElement)(_components.CardHeader, null, (0, _i18n.__)('Menu locations')), (0, _element.createElement)(_components.CardBody, null, (0, _element.createElement)("p", null, (0, _i18n.__)('There are no available menus'))));
  }

  return (0, _element.createElement)(_components.Card, null, (0, _element.createElement)(_components.CardHeader, null, (0, _i18n.__)('Menu locations')), (0, _element.createElement)(_components.CardBody, null, (0, _element.createElement)("form", {

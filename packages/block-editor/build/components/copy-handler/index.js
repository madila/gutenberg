...
function useNotifyCopy() {
  ...
  return (0, _element.useCallback)(function (eventType, selectedBlockClientIds) {
    ...
    if (selectedBlockClientIds.length === 1) {
      ...
      notice = eventType === 'copy' ? (0, _i18n.sprintf)( // Translators: Number of blocks being copied
      (0, _i18n.__)('Copied %d blocks to clipboard.'), selectedBlockClientIds.length) : (0, _i18n.sprintf)( // Translators: Number of blocks being cut
      (0, _i18n.__)('Moved %d blocks to clipboard.'), selectedBlockClientIds.length);
    }
...
function CopyHandler(_ref) {
  ...
  var handler = function handler(event) {
    ...
    if (!hasMultiSelection()) {
      ...
      var hasSelection = event.type === 'copy' || event.type === 'cut' ? (0, _dom.documentHasUncollapsedSelection)() : (0, _dom.documentHasSelection)(); // Let native copy behaviour take over in input fields.

...
function MediaPlaceholder(props) {
  var addToGallery = props.addToGallery,
      ...
      value = _props$value === void 0 ? [] : _props$value; // use ref to keep media array current for callbacks during rerenders
  ...
  return (0, _element.createElement)(_reactNative.View, {
    ...
    render: function render(_ref) {
      ...
      return (0, _element.createElement)(_reactNative.TouchableWithoutFeedback, {
        ...
        style: [emptyStateContainerStyle, isAppender && appenderStyle]
      }, getMediaOptions(), renderContent()));
    }
  }));
}

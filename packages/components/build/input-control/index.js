...
function InputControl(_ref, ref) {
  var _ref$__unstableStateR = _ref.__unstableStateReducer,
    ...
    return state;
      ...
      suffix = _ref.suffix,
      value = _ref.value,
      props = (0, _objectWithoutProperties2.default)(_ref, ["__unstableStateReducer", "children", "className", "disabled", "hideLabelFromVision", "id", "isPressEnterToChange", "isFloatingLabel", "label", "labelPosition", "onBlur", "onChange", "onFocus", "onValidate", "onKeyDown", "prefix", "size", "suffix", "value"]);
  ...
  var _useState3 = (0, _element.useState)(!(0, _values.isValueEmpty)(value)),
  ...
  var isInputFilled = isFilled || !(0, _values.isValueEmpty)(value);
  ...
  }, prefix), (0, _element.createElement)(_inputField.default, (0, _extends2.default)({}, props, {

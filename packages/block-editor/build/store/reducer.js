  ...
  return function () {
    ...
    switch (action.type) {
      ...
      case 'UPDATE_BLOCK_ATTRIBUTES':
        newState.cache = _objectSpread({}, newState.cache, {}, fillKeysWithEmptyObject(getBlocksWithParentsClientIds(action.clientIds)));
        break;
  ...
  return function (state, action) {
    if (state && action.type === 'RESET_BLOCKS') {
      ...
      return _objectSpread({}, state, {
        ...
        order: _objectSpread({}, (0, _lodash.omit)(state.order, visibleClientIds), {}, (0, _lodash.omit)(mapBlockOrder(action.blocks), controlledInnerBlocks)),
        parents: _objectSpread({}, (0, _lodash.omit)(state.parents, visibleClientIds), {}, mapBlockParents(action.blocks)),
        cache: _objectSpread({}, (0, _lodash.omit)(state.cache, visibleClientIds), {}, (0, _lodash.omit)((0, _lodash.mapValues)(flattenBlocks(action.blocks), function () {
          return {};
...
var withReplaceInnerBlocks = function withReplaceInnerBlocks(reducer) {
  return function (state, action) {
    ...
    if (action.blocks.length) {
      ...
      stateAfterInsert.order = _objectSpread({}, stateAfterInsert.order, {}, (0, _lodash.reduce)(nestedControllers, function (result, value, key) {
        if (state.order[key]) {
...
withBlockReset, withPersistentBlockChange, withIgnoredBlockChange)({
      ...
      case 'UPDATE_BLOCK_ATTRIBUTES':
        {
          ...
          var next = action.clientIds.reduce(function (accumulator, id) {
            return _objectSpread({}, accumulator, (0, _defineProperty2.default)({}, id, (0, _lodash.reduce)(action.attributes, function (result, value, key) {
      ...
      case 'MOVE_BLOCKS_TO_POSITION':
        {
          ...
          if (fromRootClientId === toRootClientId) {
            ...
            return _objectSpread({}, state, (0, _defineProperty2.default)({}, toRootClientId, (0, _array.moveTo)(state[toRootClientId], fromIndex, _index, clientIds.length)));
          } // Moving from a parent block to another


          return _objectSpread({}, state, (_objectSpread7 = {}, (0, _defineProperty2.default)(_objectSpread7, fromRootClientId, _lodash.without.apply(void 0, [state[fromRootClientId]].concat((0, _toConsumableArray2.default)(clientIds)))), (0, _defineProperty2.default)(_objectSpread7, toRootClientId, (0, _array.insertAt)(state[toRootClientId], clientIds, _index)), _objectSpread7));
        }
      ...
      case 'MOVE_BLOCKS_UP':
        {
          ...
          return _objectSpread({}, state, (0, _defineProperty2.default)({}, _rootClientId, (0, _array.moveTo)(_subState2, firstIndex, firstIndex - 1, _clientIds.length)));
        }
      ...
      case 'MOVE_BLOCKS_DOWN':
        {
          ...
          return _objectSpread({}, state, (0, _defineProperty2.default)({}, _rootClientId2, (0, _array.moveTo)(_subState3, _firstIndex, _firstIndex + 1, _clientIds2.length)));
        }
  ...
  parents: function parents() {
    ...
    switch (action.type) {
      ...
      case 'MOVE_BLOCKS_TO_POSITION':
        {
          return _objectSpread({}, state, {}, action.clientIds.reduce(function (accumulator, id) {
  ...
  controlledInnerBlocks: function controlledInnerBlocks() {
    ...
    if (type === 'SET_HAS_CONTROLLED_INNER_BLOCKS') {
      return _objectSpread({}, state, (0, _defineProperty2.default)({}, clientId, hasControlledInnerBlocks));
    }
  ...
  switch (action.type) {
    ...
    case 'UPDATE_BLOCK_ATTRIBUTES':
      return action.clientIds.reduce(function (accumulator, id) {
        return _objectSpread({}, accumulator, (0, _defineProperty2.default)({}, id, action.attributes));
      }, {});
  }

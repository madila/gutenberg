...
var BlockList = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(BlockList, [{
    ...
    value: function getExtraData() {
      ...
      if (this.extraData.parentWidth !== parentWidth || this.extraData.renderFooterAppender !== renderFooterAppender || this.extraData.onDeleteBlock !== onDeleteBlock || this.extraData.contentStyle !== contentStyle) {
        this.extraData = {

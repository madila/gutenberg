...
function ColorEdit(props) {
  ...
  var onChangeLinkColor = function onChangeLinkColor(value) {
    ...
    var colorObject = (0, _colors.getColorObjectByColorValue)(colors, value);
    props.setAttributes({
      style: _objectSpread({}, props.attributes.style, {
        color: _objectSpread({}, (_props$attributes$sty = props.attributes.style) === null || _props$attributes$sty === void 0 ? void 0 : _props$attributes$sty.color, {
  ...
  return (0, _element.createElement)(_colorPanel.default, {
    ...
    }].concat((0, _toConsumableArray2.default)(__experimentalEnableLinkColor && hasLinkColorSupport(blockName) ? [{
...
var withColorPaletteStyles = (0, _compose.createHigherOrderComponent)(function (BlockListBlock) {
  return function (props) {
    ...
    wrapperProps = _objectSpread({}, props.wrapperProps, {
      style: _objectSpread({}, extraStyles, {}, (_props$wrapperProps = props.wrapperProps) === null || _props$wrapperProps === void 0 ? void 0 : _props$wrapperProps.style)
    });

...
function CoverEdit(_ref3) {
  ...
  var style = _objectSpread({}, isImageBackground ? (0, _shared.backgroundImageStyles)(url) : {}, {
  ...
  if (!hasBackground) {
    ...
    return (0, _element.createElement)(_element.Fragment, null, controls, (0, _element.createElement)(_blockEditor.__experimentalBlock.div, {
